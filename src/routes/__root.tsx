...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Trivia de Games — Quiz sobre videogames" },
      { name: "description", content: "Quiz interativo de trivia sobre videogames, com categorias e níveis de dificuldade." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Trivia de Games" },
      { property: "og:description", content: "Quiz interativo de trivia sobre videogames, com categorias e níveis de dificuldade." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Trivia de Games" },
      { name: "twitter:description", content: "Quiz interativo de trivia sobre videogames, com categorias e níveis de dificuldade." },
